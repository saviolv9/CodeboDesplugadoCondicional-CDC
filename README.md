CodeBô Desplugado Condicional (CDC) 🤖🧱

O CodeBô Desplugado Condicional (CDC) é um jogo sério desplugado projetado para o ensino e aprendizagem de lógica de programação na educação básica. Ele foca especificamente no conceito de estruturas condicionais (SE/ENTÃO), permitindo que estudantes compreendam o fluxo de decisão de um algoritmo de forma tátil, visual e sem a necessidade de computadores.
...
•	Cartas de Comando: Blocos lógicos representativos (Avançar, Virar, Condicionais).
